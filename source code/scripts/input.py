...
from special import windows_interacter
...
def read_input():
    global texture_update, running, next_track, previous_track
    counter = 0
    while running:
        key_pressed = read_key()
        if windows_interacter.registered:
            if key_pressed == 'play/pause media' or key_pressed == 'next track' or key_pressed == 'previous track':
                if key_pressed == 'play/pause media':
                    counter += 1
                    if counter == 1:
                        ...
                        counter = 0
                elif key_pressed == 'next track':
                    counter += 1
                    if counter == 1:
                        next_track = True
                    elif counter == 2:
                        counter = 0
                elif key_pressed == 'previous track':
                    counter += 1
                    if counter == 1:
                        previous_track = True
                    elif counter == 2:
...
def update_inputs():
    global mouse_position, Any_Button_Pressed, mouse_scroll_value, mouse_scroll_velocity, mouse_scroll_drag, keys
    Any_Button_Pressed = False
    mouse_position = pygame.mouse.get_pos()
